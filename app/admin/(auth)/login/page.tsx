...
// 1. Buat komponen terpisah khusus untuk Form yang membutuhkan useSearchParams
function LoginForm() {
...
// 2. Komponen Utama yang membungkus LoginForm dengan Suspense
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-slate-900 px-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8 space-y-6">
        ...
        {/* 3. Suspense Boundary dipasang di sini */}
        <Suspense
          fallback={
